...
The second step is trying trying to set a benchmark for the actual task - text generation: How well would the model perform after fine tuning?   
To be exact, I am planning on fine-tuning a seq2seq model, that simply takes in the clue, and output the word. I will pick BART and T5 as my benchmark. They are both suitable for seq2seq tasks. As oppose to Bert, Roberta, Deberta, they don't have a build-in seq2seq head, I am not wrtting that language modeling head myself.  
